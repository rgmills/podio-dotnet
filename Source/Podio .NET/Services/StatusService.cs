...
namespace PodioAPI.Services
{
    public class StatusService
    {
        ...
        /// <returns></returns>
        public Task<Status> AddNewStatusMessage(int spaceId, string text, List<int> fileIds = null, int? embedId = null,
        ...
        /// </param>
        /// <param name="embedUrl">The url to be attached</param>
        public Task<dynamic> UpdateStatusMessage(int statusId, string text, List<int> fileIds = null, int? embedId = null,
        ...
        /// </summary>
        /// <param name="statusId"></param>
        public Task<dynamic> DeleteStatusMessage(int statusId)
        {
            string url = string.Format("/status/{0}", statusId);
