...
namespace PodioAPI.Services
{
    public class ConversationService
    {
        ...
        public Task<dynamic> AddParticipants(int conversationId, List<Ref> participants)
        {
        ...
        /// <param name="conversationCreateRequest"></param>
        /// <returns></returns>
        public Task<Conversation> CreateConversationOnObject(string refType, int refId,
        ...
        public Task<dynamic> LeaveConversation(int converstionId)
        {
        ...
        /// </summary>
        /// <param name="conversationId"></param>
        public Task<dynamic> MarkConversationAsRead(int conversationId)
        {
        ...
        ///     <para>Podio API Reference: https://developers.podio.com/doc/conversations/mark-conversation-as-read-35441525 </para>
        /// </summary>
        public Task<dynamic> MarkAllConversationsAsRead()
        {
        ...
        /// </summary>
        /// <param name="converstionId"></param>
        public Task<dynamic> MarkConversationAsUnread(int converstionId)
        {
        ...
        /// <returns></returns>
        public Task<ConversationEvent> ReplyToConversation(int converstionId, string text, List<int> fileIds = null,
        ...
        /// </summary>
        /// <param name="converstionId"></param>
        public Task<dynamic> StarConversation(int converstionId)
        {
        ...
        /// </summary>
        /// <param name="converstionId"></param>
        public Task<dynamic> UnstarConversation(int converstionId)
        {
            string url = string.Format("/conversation/{0}/star", converstionId);
            return  _podio.Delete<dynamic>(url);
        }
        ...
        /// </param>
        /// <returns></returns>
        public Task<List<Conversation>> SearchConversations(string text, int limit = 10, int offset = 0,
