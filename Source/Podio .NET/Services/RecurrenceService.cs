...
namespace PodioAPI.Services
{
    public class RecurrenceService
    {
        ...
        /// <param name="refType"></param>
        /// <param name="refId"></param>
        public Task<dynamic> DeleteRecurrence(string refType, int refId)
        {
            string url = string.Format("/recurrence/{0}/{1}", refType, refId);
        ...
        public Task<dynamic> UpdateRecurrence(string refType, int refId, Recurrence recurrence)
        {
            string url = string.Format("/recurrence/{0}/{1}", refType, refId);
            return _podio.Put<dynamic>(url, recurrence);
        }
    }
}