...
namespace PodioAPI.Services
{
    public class TagService
    {
        ...
        public Task<dynamic> CreateTags(string refType, int refId, List<string> tags)
        {
            string url = string.Format("/tag/{0}/{1}/", refType, refId);
            return _podio.Post<dynamic>(url, tags);
        }
        ...
        /// <returns></returns>
        public Task<List<TaggedObject>> GetObjectsOnAppWithTag(int appId, string text)
        {
        ...
        /// <returns></returns>
        public Task<List<TaggedObject>> GetObjectsOnOrganizationWithTag(int orgId, string text)
        {
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public Task<List<TaggedObject>> GetObjectsOnSpaceWithTag(int spaceId, string text)
        {
        ...
        /// <param name="text">The tag to search for.</param>
        /// <returns></returns>
        public Task<List<Tag>> GetTagsOnApp(int appId, int? limit = null, string text = null)
        {
        ...
        /// <param name="text">The tag to search for</param>
        /// <returns></returns>
        public Task<List<string>> GetTagsOnAppTop(int appId, int? limit = null, string text = null)
        {
        ...
        /// <param name="text">The tag to search for</param>
        /// <returns></returns>
        public Task<List<Tag>> GetTagsOnOrganization(int orgId, int? limit = null, string text = null)
        {
        ...
        /// <param name="text">The tag to search for</param>
        /// <returns></returns>
        public Task<List<Tag>> GetTagsOnSpace(int spaceId, int? limit = null, string text = null)
        {
        ...
        /// <param name="refId"></param>
        /// <param name="text">The tag to search for</param>
        public Task<dynamic> RemoveTag(string refType, int refId, string text)
        {
        ...
        /// <param name="refId"></param>
        /// <param name="tags"></param>
        public Task<dynamic> UpdateTags(string refType, int refId, List<string> tags)
        {
            string url = string.Format("/tag/{0}/{1}/", refType, refId);
            return _podio.Put<dynamic>(url, tags);
        }
    }
}