...
namespace PodioAPI.Services
{
    public class ViewService
    {
        ...
        /// <returns></returns>
        public Task<View> GetView(int appId, string viewIdOrName)
        {
        ...
        /// <returns></returns>
        public Task<List<View>> GetViews(int appId, bool includeStandardViews = false)
        {
            string url = string.Format("/view/app/{0}/", appId);
        ...
        public Task<dynamic> DeleteView(int viewId)
        {
        ...
        public Task<dynamic> UpdateLastView(int appId, ViewCreateUpdateRequest request)
        {
            string url = string.Format("/view/app/{0}/last", appId);
            return   _podio.Put<dynamic>(url, request);
        }
        ...
        /// <param name="viewId"></param>
        /// <param name="request"></param>
        public Task<dynamic> UpdateView(int viewId, ViewCreateUpdateRequest request)
        {
            string url = string.Format("/view/{0}", viewId);
            return   _podio.Put<dynamic>(url, request);
        }
