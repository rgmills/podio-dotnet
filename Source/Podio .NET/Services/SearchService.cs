...
namespace PodioAPI.Services
{
    public class SearchService
    {
        ...
        /// </param>
        /// <returns></returns>
        public Task<List<SearchResult>> SearchGlobally(string query, int? limit = null, int offset = 0, string refType = null)
        {
            string url = "/search/";
        ...
        /// </param>
        /// <returns></returns>
        public Task<List<SearchResult>> SearchInApp(int appId, string query, int? limit = null, int offset = 0,
            string refType = null)
        {
        ...
        /// </param>
        /// <returns></returns>
        public Task<List<SearchResult>> SearchInOrganization(int orgId, string query, int? limit = null, int offset = 0,
            string refType = null)
        {
        ...
        /// </param>
        /// <returns></returns>
        public Task<List<SearchResult>> SearchInSpace(int spaceId, string query, int? limit = null, int offset = 0,
            string refType = null)
        {
